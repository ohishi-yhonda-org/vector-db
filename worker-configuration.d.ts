/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 2910e026d05706fef7c277fe90d08c10)
// Runtime types generated with workerd@1.20250823.0 2024-12-18 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		...
		NOTION_API_KEY: "";
		VECTOR_CACHE: DurableObjectNamespace<import("./src/index").VectorManager>;
		VECTOR_MANAGER: DurableObjectNamespace<import("./src/index").VectorManager>;
		AI_EMBEDDINGS: DurableObjectNamespace<import("./src/index").AIEmbeddings>;
		NOTION_MANAGER: DurableObjectNamespace<import("./src/index").NotionManager>;
		DB: D1Database;
		VECTORIZE_INDEX: VectorizeIndex;
		AI: Ai;
		EMBEDDINGS_WORKFLOW: Workflow;
		BATCH_EMBEDDINGS_WORKFLOW: Workflow;
		VECTOR_OPERATIONS_WORKFLOW: Workflow;
		FILE_PROCESSING_WORKFLOW: Workflow;
		NOTION_SYNC_WORKFLOW: Workflow;
	}
}
